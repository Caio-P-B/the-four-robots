...
async function robot() {
    ...
    async function authenticateWithOAuth() {
        ...
        const autorizathionToken = await waitForGoogleCallback(webServer)
        await requestGoogleForAccessTokens(OAuthClient, autorizathionToken)
        ...
        async function requestGoogleForAccessTokens(OAuthClient, autorizathionToken) {
            return new Promise((resolve, reject) => {
                OAuthClient.getToken(autorizathionToken, (error, tokens) => {
                    if (error) {
                        return reject(error)
                    }
